...
| 날씨 | 메뉴 | 평소 | 비 오는 날 | 증가율 |
|------|------|------|----------|--------|
| 🌧️ 비 | **파전** | 2.5 | 11.2 | **+345.4%** 🔥 |
| 🌧️ 비 | 설렁탕 | 30.4 | 40.3 | +32.4% |
| 🌧️ 비 | 빙수 | 35.5 | 45.1 | +27.1% |
| 🌧️ 비 | 국밥 | 50.5 | 56.9 | +12.7% |
| 🌧️ 비 | 떡볶이 | 62.7 | 69.0 | +9.9% |

**☀️ 더운 날**: 냉면, 빙수, 콩국수, 아이스아메리카노 (기존 데이터)  
**❄️ 추운 날**: 김치찌개, 설렁탕, 국밥, 라면 (기존 데이터)

**🔥 주요 발견**:
- **"비 오면 파전"** - 드디어 증명! (+345.4%)
- **일별 분석의 중요성** - 월별 평균으로는 특정 날 급증을 못 잡음
- **Lag 효과** - 비 오기 전날 +20% → 당일 급증 → 다음날 -42% 복귀
...
| 기분 | 추천 메뉴 경향 | 특징 |
|------|--------------|------|
| 😤 스트레스 | 떡볶이, 치킨, 피자, 마라탕 | 매운맛 + 고칼로리 |
| 😢 우울함 | 라면, 치킨, 비빔밥 | 익숙하고 위안되는 음식 |
| 🤒 피곤함 | 삼계탕, 장어, 국밥, 칼국수 | 보양식, 영양 보충 |
| 😊 기분 좋음 | 파스타, 스테이크, 초밥 | 특별한 외식 메뉴 |
