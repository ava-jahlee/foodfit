 ...
 * 
 * 사용법: node scripts/collectFoodData.js
 */
...
const foodKeywords = [
  '파전', '해물전', '김치전', '녹두전', '부침개',
  '칼국수', '라면', '수제비', '부대찌개', '김치찌개', '된장찌개',
  '삼계탕', '냉면', '냉모밀', '콩국수', '비빔밥', '샐러드', '초밥',
  '회덮밥', '생선회', '광어회', '연어회',  // '회' 단독 제외
  ...
  '쌀국수', '포케', '닭가슴살', '두부', '곤약', '막국수',  // '전' 제거
  '물회', '냉콩국수', '팥빙수', '아이스크림', '빙수', '보양식',
  '추어탕', '매운탕', '아귀찜', '찜', '탕', '국', '면', '밥'
]
